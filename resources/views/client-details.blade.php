...
<div class="page-wrapper">
	<div class="page-content">
		...
		<div class="card">
			<div class="card-body">
				<ul class="list-group">
					<li class="list-group-item d-flex justify-content-between"><b>Client Name :</b><p>{{ $client->cname}}</p></li>
					<li class="list-group-item d-flex justify-content-between"><b>Company Name :</b><p>{{ $client->coname}}</p></li>
					<li class="list-group-item d-flex justify-content-between"><b>Email ID :</b><p>{{ $client->email}}</p></li>
					<li class="list-group-item d-flex justify-content-between"><b>Contact No :</b><p>{{ $client->phone}}</p></li>
				</ul>
			</div>
		</div>
		<div class="card">
			...
			<div class="card-body">
				<div class="d-lg-flex align-items-center mb-4 gap-3">
					...
					<div class="ms-auto">
						<a href="{{ route('services.create') }}?client_id={{ $client->id }}" class="btn btn-primary radius-30 mt-2 mt-lg-0">
								...
								<tr>
									<td colspan="9" class="text-center py-4">
										<div class="d-flex flex-column align-items-center">
											...
											<a href="{{ route('services.create') }}?client_id={{ $client->id }}" class="btn btn-primary btn-sm">
