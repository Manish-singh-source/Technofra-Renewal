									...
									<div class="mt-2">
										...
										<span class="
											@php
												...
												echo $daysLeft <= 1 ? 'text-danger' : ($daysLeft <= 7 ? 'text-warning' : 'text-info');
											@endphp
										">
						...
						<form method="POST" action="{{ route('send-mail.send') }}">
							...
							<div class="row g-3">
								...
								<div class="col-md-12">
									...
									<div class="form-text">Separate multiple email addresses with commas (e.g., email1@example.com, email2@example.com)</div>
									@error('cc_emails')
										<div class="invalid-feedback">{{ $message }}</div>
									@enderror
								</div>
								...
								<div class="col-md-12">
									...
									<textarea class="form-control ckeditor @error('message') is-invalid @enderror"
											  ...
											  placeholder="Enter your email message..." rows="8" required>{{ old('message', 'Dear ' . ($service->client->cname ?? 'Valued Client') . ',
